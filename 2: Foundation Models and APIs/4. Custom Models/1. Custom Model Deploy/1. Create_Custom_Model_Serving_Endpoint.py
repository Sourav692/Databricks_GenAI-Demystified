...
# Provide your own catalog and schema name. Here is an example:
catalog = "main"
schema = "models"
...
with mlflow.start_run() as run:
    ...
    mlflow.pyfunc.log_model(
      ...
      registered_model_name=f'{catalog}.{schema}.bert-encoder'
    )
